...
pro obs_color,min,max,bin
  ...
  device,filename='plots/SPIRE_obs_c1_hist.eps',xsize=10,ysize=8,/inches,/encapsulated,/times,set_font='Times-Roman',/color
  ...
  set_plot,'ps'
  device,filename='plots/SPIRE_obs_color.eps',xsize=10,ysize=8,/inches,/encapsulated,/times,set_font='Times-Roman'
  plot,c1,c2,psym=2,xrange=[min,max],yrange=[min,max]

  device,/close

  device,filename='plots/SPIRE_obs_color_hist.eps',xsize=10,ysize=8,/inches,/encapsulated,/times,set_font='Times-Roman',/color
