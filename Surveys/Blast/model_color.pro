...
pro model_color,min,max,bin
  ...
  t_num = mod_num*9.999/max(mod_num)
  mod_num = fix(mod_num)
  t_num = fix(t_num)
  
  num = n_elements(redshift)
  e250 = blast_errors(num,250)
  e350 = blast_errors(num,350)
  e500 = blast_errors(num,500)

  device,filename='plots/redshift_distribution.eps',xsize=10,ysize=8,/inches,/encapsulated,/times,set_font='Times-Roman',/color
  h = histogram(redshift,nbins=200,locations=xz)
  plot,xz,h,psym=10,xtitle=textoidl('z'),ytitle=textoidl('Number')
  device,/close

  device,filename='plots/model_distribution.eps',xsize=10,ysize=8,/inches,/encapsulated,/times,set_font='Times-Roman',/color
  h = histogram(mod_num,binsize=1,locations=xh)
  plot,xh,h,psym=10,xtitle=textoidl('\Beta Index'),ytitle=textoidl('Number')
  device,/close

  device,filename='plots/temperature_distribution.eps',xsize=10,ysize=8,/inches,/encapsulated,/times,set_font='Times-Roman',/color
  ...
  device,filename='plots/model_c1_hist.eps',xsize=10,ysize=8,/inches,/encapsulated,/times,set_font='Times-Roman',/color
  plot,xc1,res/total(res),psym=10
  device,/close

  device,filename='plots/model_color_hist.eps',xsize=10,ysize=8,/inches,/encapsulated,/times,set_font='Times-Roman',/color
