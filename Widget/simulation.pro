...
;is in meters, whereas we use microns normally
  if(file_test('params.save')) then begin
     ...
     ldat0={phi0:-2.2,lo:10.14,alpha:0.5,beta:3.0,p:6.7,q:3.5,zcut:2.0}
     ldat1={phi0:1.0,lo:1.0,alpha:1.0,beta:1.0,p:0.0,q:0.0,zcut:1.0}
     ldat2={phi0:-5.0,lo:9.0,alpha:0.0,beta:0.0,p:0.0,q:0.0,zcut:0.0}
     ldat3={phi0:5.0,lo:11.0,alpha:2.0,beta:5.0,p:10.0,q:10.0,zcut:0.0}
     ldat4={phi0:0.0,lo:0.0,alpha:0.0,beta:0.0,p:0.1,q:0.1,zcut:0.0}
...
pro diagnostics
  ...
  size_screen=0.8*get_screen_size()
  size_screen_alt = size_screen*0.85
