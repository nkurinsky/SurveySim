...
mfile=simname+"8_model.fits"
outfile=simname+"8_output.fits"
...
#MB-change
#mod.params['P2'].pmin=-5.75
#mod.params['P2'].pmax=-0.75
...
#MB-change
#mod.params['Q2'].value=1.20
#mod.params['Q2'].pmin=-1.01
#mod.params['Q2'].pmax=3.40
#mod.params['Q2'].value=1.20
#mod.params['Q2'].pmin=0.80
#mod.params['Q2'].pmax=1.60
